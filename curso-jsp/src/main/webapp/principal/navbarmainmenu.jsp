	...
	<div class="pcoded-inner-navbar main-menu">
		...
		<ul class="pcoded-item pcoded-left-item">
			...
			<li class="pcoded-hasmenu"><a href="javascript:void(0)"
				...
				<ul class="pcoded-submenu">
					...
					<li class=" "><a
						href="<%=request.getContextPath()%>/ServletTelefoneStatus?acao=listaFone"
						class="waves-effect waves-dark"> <span class="pcoded-micon"><i
								class="ti-angle-right"></i></span> <span class="pcoded-mtext"
							data-i18n="nav.basic-components.alert">Telefones</span> <span
							class="pcoded-mcaret"></span>
					</a></li>
		...
		<ul class="pcoded-item pcoded-left-item">
			...
			<li><a href="<%=request.getContextPath()%>/principal/relusergrafico.jsp"
				class="waves-effect waves-dark"> <span class="pcoded-micon"><i
						class="ti-layers"></i><b>FC</b></span> <span class="pcoded-mtext"
					data-i18n="nav.form-components.main">Gráfico de Salário</span> <span
					class="pcoded-mcaret"></span>
			</a></li>
			<!--
